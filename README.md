...
| [`shorten-it`](shorten-it/SKILL.md)                 | Shorten selected or provided text while preserving meaning, tone, nuance, and important details. Use for condensing, trimming, making concise, or reducing length without changing substance.                                                                                                                                                    |
