...
| [`explain-code`](explain-code/SKILL.md)             | Explain code at any scope — a completed change, a module, or the whole codebase — with an optional quiz that surfaces gaps in the user's understanding.                                                                                                                                             |
