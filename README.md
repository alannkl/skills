...
| [`explain-it`](explain-it/SKILL.md)                 | Explain any non-code target — a concept, document, design, or process — with an optional quiz that surfaces understanding gaps and an optional interactive micro-world for hard-to-hold dynamics.                                                                                                   |
