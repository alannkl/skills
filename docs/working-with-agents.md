...
### 3. Separate understanding, planning, and execution
...
### 4. Give the agent a way to verify its own work
...
### 5. Calibrate autonomy to risk and reversibility
...
### 6. Course-correct early; restart rather than argue
...
### 7. Treat the agent's attention (context) as a scarce resource
...
### 8. Independent review — don't let the worker grade itself
...
### 9. Preserve reversibility and legibility of the agent's work
...
### 10. Maintain your own understanding — calibrated, not blind, trust
...
### 11. Invest in the environment; feedback should compound
...
### 12. Iterate on your own practice
...
**In one sentence:** be precise about intent and success criteria, make verification objective and independent, scale oversight to risk, keep feedback loops tight and contexts clean, and stay the accountable owner of the result.

## How these principles map to skills in this repo

| Principle | Agent-side embodiment |
| --- | --- |
| #2 intent and success criteria, #3 plan before executing | [`grill-to-plan`](../grill-to-plan/SKILL.md) |
| #3 scoped execution, #5 risk-scaled process, #9 legible work | [`coding-discipline`](../coding-discipline/SKILL.md) |
| #8 independent review | [`code-review`](../code-review/SKILL.md) |
| #4 evidence over assertion | Not yet embodied — candidate future skill: make the agent always show the check it ran (test output, command + result) instead of claiming success |
