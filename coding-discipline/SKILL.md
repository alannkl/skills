...
description: Apply disciplined software engineering habits that keep agent-written code simple, scoped, maintainable, and verifiable. Use when doing non-trivial implementation, bug fixing, refactoring, review, test work, code-adjacent documentation, or architecture-sensitive changes, unless the user explicitly asks for throwaway or exploratory work.
---
...
- Simplicity first: build the smallest correct solution; avoid unrequested features, abstractions, flexibility, or speculative safeguards unless risk or system contracts justify them.
...
Applies to non-trivial implementation, bug fixes, refactors, reviews, tests, code-adjacent docs, and architecture-sensitive changes. Skip it for trivial formatting, pure prose edits, or work the user explicitly wants as a quick throwaway prototype.
...
2. Define the smallest verifiable plan.
   ...
   - Restate the criteria when finishing and confirm each one passed.

3. Preserve system shape.
   - Keep layers and responsibilities separate: boundary adapters validate and translate, core logic decides, persistence/integration code performs I/O.
...
4. Write clear code.
   ...
   - Suggest or add high-quality dependencies when they reduce complexity, risk, or maintenance; account for security, licensing, bundle, compatibility, and repo fit before adopting them.
...
9. Validate and finish cleanly.
   ...
   - Summarize the handoff for the user: what changed and why, assumptions made, what was intentionally left out, and what remains unverified or risky.
